...
alias deepj2eebuild='g {client,e2e-test,j2ee-war-noauth,model-api,model-jpa,model-jpa-j2ee,peer,peer-rpc,peer-server-integration,rpc,server,server-module-j2ee,test-util,user-service-api,user-service-openid,prod-j2ee-war,installer-j2ee-server}:build'
